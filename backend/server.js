...
// ============================
// DATABASE CONNECT (default to local)
// ============================
if (!process.env.MONGO_URI) {
  console.warn('⚠️ MONGO_URI not set — using local MongoDB at mongodb://127.0.0.1:27017/chat_app');
...
// NOTE: DNS SRV test removed to avoid noisy lookup errors during local development.
